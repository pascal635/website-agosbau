...
| 7 | Monitor | Google Search Console | Impressions, Klicks, Rankings, Indexierung | **mcp (`mcp__gsc__*`)**, Property `https://agosbau.de/` (URL-Präfix; Domain-Property kann das MCP nicht adressieren) | MCP-Account als *Full User* eingetragen 2026-09-22 ✓ — **nur lesend + URL-Prüfung**; Sitemap-Submit per API verweigert (Inhaber-Recht/Scope) → über UI · Daten ab 2026-08-18 | 2026-09-22 |
