...
export const cities: City[] = [
  {
    ...
    metaDesc: "Fliesenleger & Badsanierung in Bremen-Oberneuland. Fachbetrieb aus Achim, Festpreis, Referenz vor Ort: zwei Villen mit Großformatfliesen. Jetzt anfragen.",
  ...
  },
  {
    ...
    metaDesc: "Fliesenleger & Badsanierung in Bremen-Schwachhausen: Erfahrung mit Altbau und Stadtvillen, Abdichtung nach DIN 18534, Festpreis. Jetzt anfragen.",
  ...
  },
  {
    ...
    metaDesc: "Fliesenleger & Badsanierung in Lilienthal bei Bremen: Einfamilienhäuser, Festpreis, saubere Abdichtung. Fachbetrieb aus Achim. Jetzt anfragen.",
